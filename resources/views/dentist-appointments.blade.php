...
@section('content')
    ...
    <section>
        <div style="margin-bottom: 20px; background: #edf2f7; padding: 15px; border-radius: 6px; border: 1px solid #cbd5e0;">
            <form action="/dentist/appointments" method="GET" style="display: flex; align-items: center; gap: 15px; margin: 0;">
                ...
                @if(request('status_id'))
                    <a href="/dentist/appointments" style="color: #c53030; font-weight: bold; text-decoration: none;">Clear Filter</a>
                @endif
            </form>
        </div>
